...
<head>
  ...
  <title>LXEVENTSPRO - Contact</title>
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Contact</h2>
            <p>For any inquries you may send us an email below. </p>
      ...
      <div class="row justify-content-center mt-4">
        ...
        <div class="col-lg-9">
          <form action="form.php" method="post" role="form" class="">
            ...
            <div class="text-center" id="sendmessage"><button type="submit">Send Message</button></div>
          </form>
