...
<head>
  ...
  <title>LXEVENTSPRO - Services</title>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="contact2.php" class="stretched-link">Audio</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="contact2.php" class="stretched-link">Lighting</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="contact2.php" class="stretched-link">LED Wall</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="contact2.php" class="stretched-link">Trusses and Roofing</a></h4>
